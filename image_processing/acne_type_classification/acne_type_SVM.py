...
Original file is located at
    https://colab.research.google.com/drive/1ExZnB_oV7YcMeUggLyLgsgs7tqeQDl5p
"""
...
"""max_size = max(y_train.count("open comedone"), y_train.count("closed comedone"), y_train.count("pustules"), y_train.count("cystic"),
               y_train.count("nodular acne"), y_train.count("papules"))
weights = {"open comedone": max_size/y_train.count("open comedone"), "closed comedone": max_size/y_train.count("closed comedone"), 
           "pustules": max_size/y_train.count("pustules"), "cystic": max_size/y_train.count("cystic"), 
           "nodular acne": max_size/y_train.count("nodular acne"), "papules": max_size/y_train.count("papules")}
"""
...
for index,y in enumerate(y_train):
  if y == "cystic" or y == "nodular acne":
    y_train[index] = "cystic/nodular"

for index,y in enumerate(y_test):
  if y == "cystic" or y == "nodular acne":
    y_test[index] = "cystic/nodular"
...
import pickle
savedModel = 'savedModelAcneType.sav'
pickle.dump(model_linear, open(savedModel, 'wb'))
